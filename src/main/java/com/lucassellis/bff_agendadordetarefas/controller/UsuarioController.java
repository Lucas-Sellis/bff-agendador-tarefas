...
import com.lucassellis.bff_agendadordetarefas.business.UsuarioService;
...
@Tag(name = "Usuario", description = "Cadastro e login de usuários") // essa parte aqui é o swagger
...
public class UsuarioController {
    ...
    @PostMapping
    @Operation(summary = "Salvar usuários", description = "Cria um novo usuário") // essa parte aqui é o swagger "a tal da documentação"
